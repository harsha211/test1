...
$conn=mysqli_connect("localhost","root","","ticket_booking");
	...
	$sql1="insert into tickets(seats,date1,time1,tid,mid,uid,noticket) values ('$array1','$date','$time','$theatre','$movie','$login_session','$count1')";
	$query=mysqli_query($conn,$sql1);
	
	
	$seats11= explode(" ",$array1); 
	$count1=count($seats11);
	$sql="select * from movie where movieid='$movie'";
	...
	$sql2="select * from movie where movieid='$movie'";
	$mname="yy";
	...
	$sql3="select * from theatre where theatreid='$theatre'";
	$tname="zz";
	if(mysqli_query($conn,$sql3))
		...
		$tprice=22;
		$sql4="select * from ticketprice where seats='$array1'";
   ...
   <h3><?php echo "Price :Rs. $tprice"; ?></h3>
