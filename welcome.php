 ...
 $conn=mysqli_connect("localhost","root","","ticket_booking");
        ...
        if(mysqli_query($conn,$sql))
        {
            ...
            {       
                  ...
                  $msg.= '<a href="./moviedetails.php?data='.$mid.'"><img src="data:image/jpeg;base64,'.base64_encode($row['movieimage']). ' "  class="w3-hover-opacity" alt ="name_of_movie" height="250" width="175"style="margin:10px 25px"></a>';
...
<tr><td></td><td></td></tr>
<tr><td align="left">Mr. MUNIRAJU M</td><td align="left">Mr. CHANDRA MOHAN B</td>
<tr><td align="left">Assistant Professor,</td><td align="left">Assistant Professor,</td>
<tr><td align="left">Dept of CS&E,</td><td align="left">Dept of CS&E,</td>
<tr><td align="left">APSCE </td><td align="left"> APSCE</td>
</h1>
</div>
