  ...
  $data="";
   ...
   $data2="";
	  ...
	  if(isset($_GET['data3']))
    {
	 ...
	 echo "movie id :$data3<br>";
	 echo "date:$data<br>";
  echo "show time :$data1<br>";
  echo "theatre id :$data2";
  echo "<br><br>";
...
echo "You have selected following ".$checked_count." seat(s): <br><br>";
$seats2="";
...
if($flag==1)
{
echo "<br><br><b>Note :</b> <span>If You are sure then click confirm </span>";
