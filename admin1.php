...
.body{
	...
	width: auto;
	height: auto;
	background-image: url(css/banner2.jpg);
...
<body>
  ...
  <div class="body"></div>
 		<div class="grad"><h1><a href="index.php">back</a></h1></div>
...
<?php
   ...
   $db = new mysqli("localhost","root","","ticket_booking") or die("Connect failed: %s\n". $db -> error);
	...
	{ 
		...
		echo "<br><a href='dispt.php' class='button'><span>Display Theatres</span></a><a href='dispu.php' class='button'><span>Display Users</span></a></div>";
